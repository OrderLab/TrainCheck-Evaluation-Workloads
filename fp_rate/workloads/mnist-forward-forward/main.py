...
if __name__ == "__main__":
    ...
    mnist_train_set = torch.utils.data.Subset(MNIST("./data/", train=True, download=True, transform=transform), range(256))
    mnist_test_set = torch.utils.data.Subset(MNIST("./data/", train=False, download=True, transform=transform), range(256))


    train_loader = DataLoader(mnist_train_set)
    test_loader = DataLoader(mnist_test_set)
    net = Net([784, 500, 500])
