...
def main():
    ...
    train_dataset = torch.utils.data.Subset(APP_MATCHER('../data', train=True, download=True), range(5 * args.batch_size))
    test_dataset = torch.utils.data.Subset(APP_MATCHER('../data', train=False), range(5 * args.batch_size))
