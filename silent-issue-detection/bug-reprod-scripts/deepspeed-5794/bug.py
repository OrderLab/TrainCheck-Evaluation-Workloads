...
def run_inference_workload():
    ...
    # Convert the streaming dataset to a list and slice it to get the first 3200 examples
    dataset = list(dataset.take(6400))

    # Optionally, convert back to a Dataset object if needed
